...
class ProjectDIR:
	...
	def create_dir( self ):
		...
		self.script_name = format( str( input( 'Project Name: ' ) ) )
		try:
			self.version = format( float( input( 'Version: ' ) ) )
		except TypeError:
			print( 'Bitte gültige Zahl angeben! z.B (1.0)' )
			self.create_dir( )
		...
		if self.licenses == "gpl":
			shutil.copy( '../Python-Project-Assistant/Python-Project-Assistant/GPLv3', '../LICENSE' )
		else:
			exit( )
